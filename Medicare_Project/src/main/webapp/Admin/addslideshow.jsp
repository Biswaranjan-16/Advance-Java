			...
			<div class=" row col-lg-8 mx-auto">
				<div class="card shadow-lg border-0 rounded-lg mt-5">
					<div class="card-header">
						<h3 class="font-weight-light ">Add Slide</h3>
					</div>
					<div class="card-body">
						<form id="myform" enctype="multipart/form-data">
							<div class=" mb-3">
							<label >Slide Name</label> 
								<input type="hidden" name="event" value="addSlide">	
								
								<input type="text" class="form-control" id="slide_name" name="sname" required> 									 								
							     </div>
							     
							     <div class=" mb-3">
							     <label >Upload Slide</label> 
									<input type="file" class="form-control" id="imageFile"  name="simg" required> 
